...
<div class="explain-col">在线对比文件MD5校验码。</div>
...
<?php }else{?>
  ...
  <?php if(get_domain()=='duoduo123.com'){?>
...
<script>
<?php if($update==1 && get_domain()!='duoduo123.com'){?>
$('#sub').attr('disabled','disabled').after(' 升级到最新版本检测文件');
<?php }?>
</script>
