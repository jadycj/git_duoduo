...
<form action="index.php?mod=<?=MOD?>&act=<?=ACT?>" method="post" name="form1">
  ...
  <tr>
    ...
    <td>&nbsp;<?=html_radio(array(0=>'不可用',1=>'可用'),BACKSTAGE,'BACKSTAGE')?> 如果不能自动获取淘宝订单，请选择不可用</td>
  </tr>
  <tr>
    <td align="right">gbk转utf8：</td>
    <td>&nbsp;<?=html_radio(array(1=>'方式1',2=>'方式2'),GBK_UTF8_FUN,'GBK_UTF8_FUN')?> 中文gbk编码转utf8的方式，默认使用方式1，如果发现程序出现编码错误，使用方式2</td>
  </tr>
  <tr>
    <td align="right"></td>
