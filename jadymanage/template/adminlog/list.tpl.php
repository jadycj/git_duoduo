...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB;">
        ...
        <form name="form1" action="" method="get">
              ...
              <form name="form1" action="" method="get">
              <td width="" align="right">日期：<input style="width:70px" type="text" id="sday" name="sday" /> - <input style="width:70px" type="text" id="eday" name="eday" />&nbsp;<?=select($se_arr,$se,'se')?>：<input type="text" name="q" value="<?=$q?>" />&nbsp;<input type="submit" value="提交" /></td>
