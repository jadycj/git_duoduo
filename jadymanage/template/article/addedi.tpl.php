...
<table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  ...
  <tr>
    ...
    <td>&nbsp;<input name="source" type="text" id="source" value="<?=$row['source']?>"/> 为空默认为：<?=WEBNAME?></td>
  </tr>
  <tr>
    <td align="right">关键词：</td>
    <td>&nbsp;<input name="keyword" type="text" id="keyword" value="<?=$row['keyword']?$row['keyword']:WEBNAME?>" style="width:300px"/> 使用半角逗号“,”隔开</td>
  </tr>
  <tr>
