...
<table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  ...
  <tr>
    ...
    <td>&nbsp;<?=select($lm,$row['lm'],'lm')?>&nbsp;&nbsp;&nbsp; <a target="_blank" href="<?=$row['lm']?$lianmeng[$row['lm']]['helpurl']:$arr['helpurl']?>">教程</a></td>
  </tr>
  <tr>
    <td align="right">官网：</td>
    <td>&nbsp;<input name="url" type="text" id="url" value="<?=$row['url']?>" /> <span style="display:none" id="getmallinfo"><input type="button" value="获取信息" id="getmallinfo_button" style="cursor:pointer" />(填写后点击可直接获取商城信息)</span></td>
  </tr>
  <tr>
  ...
  <tr class="wujiumiao_tr">
    ...
    <td>&nbsp;<input name="wujiumiaoid" type="text" value="<?=$row['wujiumiaoid']?$row['wujiumiaoid']:0?>" id="wujiumiaoid" /> <input type="button" value="获取推广网址" id="get_59miao_click_url" style="cursor:pointer" /> 如选择59秒，此项必填</td>
  </tr>
  <tr class="wujiumiao_tr">
    <td align="right">59秒推广url：</td>
    <td>&nbsp;<input name="wujiumiaourl" type="text" value="<?=$row['wujiumiaourl']?>" id="wujiumiaourl" style="width:300px" /> 如选择59秒，此项必填</td>
  </tr>
  ...
  <tr class="weiyi_tr">
    ...
    <td>&nbsp;<input name="weiyiid" type="text" value="<?=$row['weiyiid']?>" id="weiyiid" /> 如选择唯一联盟，此项必填(推广网址里m=joyo中的joyo)</td>
  </tr>
