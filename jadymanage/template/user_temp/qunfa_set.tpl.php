...
<table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  ...
  <tr>
    ...
    <td>&nbsp;<?=html_radio($qunfa_arr,$do,'do')?> &nbsp;<a href="<?=u(MOD,'list',array('do'=>$do))?>">群发列表</a></td>
  </tr>
  <tr>
    <td align="right">用户名：</td>
    <td>&nbsp;<input type="text" name="ddusername" id="ddusername" value="<?=$_GET['ddusername']?>" />（模糊查询用此格式【%关键字%】）</td>
  </tr>
  <tr>
    <td align="right">会员ID：</td>
    <td>&nbsp;<input type="text" name="sid" value="" class="numWidth" />- <input type="text" name="eid" value="" class="numWidth" />（包含本身）</td>
  </tr>
  <tr>
    <td align="right">金额范围：</td>
    <td>&nbsp;<input type="text" name="smoney" value="" class="numWidth" />- <input type="text" name="emoney" value="" class="numWidth" />元 （包含本身）</td>
  </tr>
  <tr>
    <td align="right"><?=TBMONEY?>范围：</td>
    <td>&nbsp;<input type="text" name="sjifenbao" value="" class="numWidth" />- <input type="text" name="ejifenbao"  value="" class="numWidth" />个（包含本身）</td>
  </tr>
  <tr>
    <td align="right">已提现金额：</td>
    <td>&nbsp;<input type="text" name="syitixian" value="" class="numWidth" />- <input type="text" name="eyitixian" value="" class="numWidth" />元 （包含本身）</td>
  </tr>
  <tr>
    <td align="right">已提现<?=TBMONEY?>：</td>
    <td>&nbsp;<input type="text" name="stbyitixian" value="" class="numWidth" />- <input type="text" name="etbyitixian"  value="" class="numWidth" />个（包含本身）</td>
  </tr>
  <tr>
    <td align="right">等级范围：</td>
    <td>&nbsp;<input type="text" name="slevel" value="" class="numWidth"/>- <input type="text" name="elevel" value="" class="numWidth"/>（包含本身）</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;<input type="text" name="pagesize" id="pagesize" value="100" class="numWidth" />（默认100，根据服务器性能自行调整）</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;<input type="radio" checked="checked" /> 是 （短信群发必备条件）</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;{name}会替换为会员名，群发短信最好带上{name}，否则可能会因为短信内容相同造成发送失败</td>
  </tr>
</table></td>
  </tr>
