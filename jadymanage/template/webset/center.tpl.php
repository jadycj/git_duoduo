...
$session_time_last=24*3600000*$taobao_session_day;
?>
<script>
...
<div style="width:100%;">
  <div class="c_left">
    ...
    <div class="box_l">
        ...
        <ul>
		  <li><a href="#">官方便捷：</a></li>
          <li><a href="http://soft.duoduo123.com/help" target="_blank">帮助中心</a></li>
		  <li><a href="http://bbs.duoduo123.com/post.php?fid=96#breadCrumb" target="_blank">提交问题</a></li>
		  <li><a href="http://bbs.duoduo123.com/thread-htm-fid-69.html" target="_blank">风向标</a></li>
      ...
      <div class="box_l">
        ...
        <ol>
		  <li>淘宝订单获取有效倒计时：<b id="sessiontime" style="color:#F00"></b>&nbsp;&nbsp;<a style="text-decoration:underline" href="<?=u('tradelist','session')?>">获取淘宝授权</a>&nbsp;&nbsp;<a href="http://soft.duoduo123.com/help/inat/2011/1031/258.html" target="_blank" style="color:#666666">说明</a></li>
		<script>
		countDown(<?php $t=intval(TIME)-intval($webset['taobao_session']['time']);if($t>$session_time_last){echo $session_time_last;}else{echo $t;}?>,function(msg) {document.getElementById('sessiontime').innerHTML = msg;});
		</script>
      ...
      <div class="box_l">
        ...
        <ul class="shuju">
		  ...
		  <li>预计收益：<b style="color:#FF6600" ><?=($web_zsy-$need_to_pay-$tixian_sum)?> 元</b></li>
		  <li>暂时收益：<b style="color:#FF6600"><?=($web_zsy-$tixian_sum)?> 元</b></li>
  ...
  <div class="c_right">
    <div class="box_l">
	 	  <table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7;">
            ...
            <tr>
              <td colspan="2" valign="top"><span class="left_txt" style="color:#F00; font-weight:bold">&nbsp;<img src="images/ts.gif" width="12" height="12" /> 版本：<span class="banben">V8</span>_UTF-8 更新日期：</span> <span class="S3" style="color:#F00; font-weight:bold"><?=BANBEN?></span> <a style="text-decoration:underline" href="<?=u('upgrade','index')?>">检查版本</a>
			    <div style=" margin:5px 10px; clear:both; height:80px; line-height:20px; vertical-align:middle">
			      <iframe frameborder="0" marginheight="0" marginwidth="0" border="0" scrolling="No" height="80" width="100%" src="http://soft.duoduo123.com/soft_info/update_v8.html" ></iframe>
	          </div></td>
            </tr>
          </table>
	 	</div>
...
<p>第一步：网站基本设置：将网站名称，logo等设置完成。 <a href="<?=u('webset','set')?>">设置</a></p>
<p>第二步：淘宝客设置：将淘宝API调用相关设置完成。 <a href="<?=u('appkey','list')?>">设置</a></p>
<p>第三步：联盟设置：实现B2C商城返利必要步骤。 <a href="<?=u('mall','set')?>">设置</a></p>
<p>第四步：公告、帮助信息、及资讯添加。 <a href="<?=u('article','list')?>">添加</a></p>
