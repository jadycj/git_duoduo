...
<table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  <tr>
    ...
    <td>&nbsp;<textarea style="width:400px; height:150px" name="ddusername"><?=$row['ddusername']?></textarea>&nbsp; 多个会员可用空格，回车或者逗号隔开。 </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;<input name="source" type="text" id="source"/> 站内信内容，为空则不发送站内信</td>
  </tr>
  <tr>
    <td align="right">&nbsp;</td>
