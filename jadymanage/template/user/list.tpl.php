...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB">
        <tr>
              ...
              <td width="" align="right"><?=select($select3_arr,$se3,'se3')?> <?=select($select1_arr,$se1,'se1')?>：<input type="text" name="q" value="<?=$q?>" />&nbsp;<?=select($select2_arr,$se2,'se2')?>：<input type="text" style="width:30px" name="linput" value="<?=$linput?>" />-<input type="text" style="width:30px" name="hinput" value="<?=$hinput?>" />&nbsp;<input type="submit" value="提交" /></td>
