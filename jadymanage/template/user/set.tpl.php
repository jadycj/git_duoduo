...
<table id="addeditable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  ...
  <tr>
    ...
    <td>&nbsp;<input name="sign[jifenbao]" value="<?=$webset['sign']['jifenbao']?>"/> </td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="right">师徒机制：</td>
    <td>&nbsp;<?=html_radio($zhuangtai_arr,$webset['user']['shoutu'],'user[shoutu]')?> 关闭后只是前台不显示对应文字和页面，不影响推广的机制，作为应付支付宝审查用</td>
  </tr>
  ...
  <tr>
    ...
    <td>&nbsp;<input name="user[reg_jifenbao]" value="<?=$webset['user']['reg_jifenbao']?>"/> </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;<input name="user[reg_level]" value="<?=$webset['user']['reg_level']?>"/> </td>
  </tr>
  <tr>
