...
if ($page_no == 1) {
	...
	//刷新token
	if($webset['taobao_session']['auto']==1 && (int)$webset['taobao_session']['day']<TODAY){
		dd_get('https://oauth.taobao.com/token?client_id='.$webset['taoapi']['jssdk_key'].'&client_secret='.$webset['taoapi']['jssdk_secret'].'&grant_type=refresh_token&refresh_token='.$webset['taobao_session']['refresh_token'],'post');
