...
$huan=$duoduo->select_all('huan_goods', 'id,img,jifen,jifenbao,title,num,sdate,edate', "hide='0' and num>0 and (edate=0 or edate>'".TIME."') ".$where." order by sort desc,id desc limit $frmnum,$pagesize");
