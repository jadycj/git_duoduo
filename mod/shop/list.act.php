...
$page_url=u(MOD,ACT,array('cid'=>$cid,'start_level'=>$start_level,'end_level'=>$end_level,'type'=>$type,'nick'=>$nick,'px'=>$px));

$next_page=$page+1>$page_num?1:$page+1;
$next_page_url=u(MOD,ACT,array('cid'=>$cid,'start_level'=>$start_level,'end_level'=>$end_level,'type'=>$type,'nick'=>$nick,'px'=>$px,'page'=>$next_page));

$last_page=$page-1<1?1:$page-1;
$last_page_url=u(MOD,ACT,array('cid'=>$cid,'start_level'=>$start_level,'end_level'=>$end_level,'type'=>$type,'nick'=>$nick,'px'=>$px,'page'=>$last_page));
?>