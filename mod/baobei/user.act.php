...
elseif($xs==2){//他喜欢的宝贝
	...
	$baobei=$duoduo->select_all('baobei_hart as a,baobei as b,user as c','b.id,b.title,b.img,b.hart,b.hits,b.content,b.uid,c.ddusername','a.uid="'.$uid.'" and c.id=b.uid and a.baobei_id=b.id '.$where_cid.' order by b.id desc limit '.$frmnum.','.$pagesize);
}
