...
<div class="alert_bg" id="alert_fast_log_reg" style="display: block;">
	<div class="alert_box">
<div class="alert_top"><span>请登录<?=$mallname?>领取返利</span><a class="alert_close" href="<?=$url?>"></a></div>
<div class="alert_content">
<div class="sort_info">
<?php if($act!='s8'){?>
<div class="sort_pic"><?=html_img($pic,0,$row["name"])?></div>
<em></em>
<div class="sort_price" style="color:#F00"><?php if($act=='goods' || $act=='paipaigoods'){?>价格：<b class="red price"><?=$price?></b>元<br/><?php }?>最高返：<b class="red fx"><?=$fanli?$fan:0?></b>
</div>
<?php }?>
...
<div id="desc"><?=WEBNICK?>正在带您去<big><?=$mallname?></big>（最高返<span style='color:#BD0000;'><?=$fan?></span>），请稍等</div>
