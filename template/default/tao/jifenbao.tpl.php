...
<div style="width:1000px; background:#FFF; border:#D0210C 1px solid; margin:auto; margin-top:10px; padding-bottom:10px">
	<div id="jmain" style="width:950px; margin:auto;">
         <div class="jfb_top" >
         <div style="width:487px; font-size:40px; text-align:right; padding-top:45px"><b><?=WEBNICK?><?=TBMONEY?></b></div>
        ...
        <div class="qa">
			...
			<p><?=TBMONEY?>是由<?=WEBNICK?>特有的一种积分服务，具有现金价值。
				<br/>主要通过以下几种方式获得：
				<br/>1、购物返利得<?=TBMONEY?>；
				<br/>2、登录<?=WEBNICK?>，进会员中心，签到得<?=TBMONEY?>；
				<br/>3、参加网站活动得<?=TBMONEY?>（多多关注网站活动并积极参与）。
			</p>
		</div>
        <div class="qa">
			<li><h2>如何查看我有多少<?=TBMONEYUNIT?><?=TBMONEY?>？如何使用<?=TBMONEY?>？</h2></li>
            <p>登录<?=WEBNICK?>，进会员中心即可看到。<a class="link" target="_blank" href="<?=u('user','index')?>">马上查看>></a>
            	<br/><?=WEBNICK?>的<?=TBMONEYBL?><?=TBMONEYUNIT?><?=TBMONEY?>相当于1元哦！可以做以下用途：
				<br/>1、兑换集分宝；
				<br/>2、兑换实物商品；
		...
		<div class="qa">
			...
			<p><?=WEBNICK?>已与支付宝集分宝进行深入合作，您在<?=WEBNICK?>获得的返利收入（包含<?=TBMONEY?>）可随时申请兑换。返利兑换集分宝过程中的所有手续费成本，由<?=WEBNICK?>承担，您无需支付任何额外费用。
