<div class="adminmenu">
  <div class="adminmenu_bt">
    <div class="adminmenu_bt_font"><a href="<?=u('user','index')?>">后台管理中心</a></div>
   ...
   <ul>
	...
	<li><div class="adminmenu_fenxiang"></div><div class="adminmenu_a"><a id='baobei' href="<?=u('user','baobei')?>">我的晒单分享</a></div></li>
