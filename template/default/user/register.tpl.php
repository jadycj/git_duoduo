...
<table width="680" border="0" align="left" cellpadding="0" cellspacing="0">
        ...
        <?php }?>
		<tr>
		  <td height="55" align="right" >电子邮箱 *&nbsp;&nbsp;</td>
		...
		<tr>
		  ...
		  <td><input name="captcha" type="text" id="captcha" size="6" maxlength="4" style="width:50px;" class="ddinput"/>&nbsp;&nbsp;<?=yzm()?></td>
      ...
      <p>3、所有通过本站购买商品的买家均可获得一定现金金额的返还，该现金来自<?=WEBNICK?>帮助购物网站推广的佣金，所以能保证返还部分的兑现。</p>
      <p>最后，<?=WEBNICK?>祝大家购物愉快！</p>
      </fieldset>
      </div>
      </div>
