    ...
    <div class="content" style="font-size:12px; height:300px;">
      <form id="form2" name="form2" method="post" action="" onsubmit="return checkForm($(this))"  enctype="multipart/form-data">
        <table width="780" border="0" cellspacing="0" cellpadding="0" >
          <tr>
            <td height="38" align="left"><div style="border:1px solid #FFCC7F; background-color:#FFFFE5; padding:8px;">注：如果您发现系统没有自动返现给您，可能是您购买商品的时候未登录，请输入订单号进行确认，只要您输入的订单号与系统内的一致，这笔交易您就确认成功了。</div></td>
          </tr>
        </table>
        <?php if($do=='tao'){?>
        <table width="680" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
                          <td height="35" align="right">淘宝交易号：</td>
                        ...
                        <?php }else{?>
                        <tr>
                          <td height="35" align="right">返利：</td>
                          <td height="35" align="left">&nbsp;<font color="#dd0000"><?=$trade['fxje']?></font></td>
                          </tr>
                        <tr>
                        <?php }?>
                          <td height="35" align="right" id="ckjyh">输入淘宝交易号：</td>
