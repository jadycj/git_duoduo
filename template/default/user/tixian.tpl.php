	...
	$('#form1').validate({
        ...
        messages : {
            money : {
				...
				range    : '提现<?=$money_name?>应大于<?=$tixian_limit?>且小于<?=$live_money?>',
                multiple : '提现<?=$money_name?>不是<?=$txxz?>的整数倍'
            },
			mobile : {
                mobile : '手机号码格式错误'
            },
            ...
            <input type="hidden" name="sub" value="1" />
                        <table width="605" border="0" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
                            ...
                            <td width="" align="left"><label class="field_notice"><?php if($txxz>0){?>请填写<b class="bignum"><?=$txxz?></b>的整数倍，<?php }?>小于<b class="bignum"><?=$live_money?></b></label></td>
                          </tr>
                          <?php if($type==2){?>
                          <tr>
