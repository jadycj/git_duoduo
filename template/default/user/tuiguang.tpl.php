...
<H4>分享推广：</H4>
<UL>
  <LI><A  href="http://v.t.sina.com.cn/share/share.php?title=<?=urlencode("推荐一个省钱网站——#".WEBNICK."#，登录".WEBNICK."后去淘宝网购物后还可返还1.5%至30%的现金 @".WEBNICK." ".$webset['tgurl']."?rec=".$dduser['id']."")?>&url=http://<?=URL?>" target=_blank><IMG src="<?=TPLURL?>/images/share_01.gif"><BR>新浪微博</A> </LI>
  ...
  <LI><a href=javascript:window.open('http://shuqian.qq.com/post?from=3&title='+encodeURIComponent('<?=WEBNICK?>')+'&uri='+encodeURIComponent('<?=$webset['tgurl']?>?rec=<?=$dduser['id']?>')+'&jumpback=2&noui=1','favit','');void(0)><IMG src="<?=TPLURL?>/images/share_04.gif" width=48 height=49><BR>QQ书签</A> </LI>
  <LI><A  href="http://www.kaixin001.com/~repaste/repaste.php?rtitle=<?=WEBNICK?>-淘宝返现网站，帮你在淘宝网购物省钱的网站，最高可以节省35%，皇冠信誉保障！&rurl=<?=$webset['tgurl']?>?rec=<?=$dduser['id']?>" target=_blank><IMG src="<?=TPLURL?>/images/share_05.gif" width=49 height=49><BR>开心网</A> </LI>
  <LI><A  href="http://xianguo.com/service/submitdigg/?title=<?=urlencode("推荐一个省钱网站——#".WEBNICK."#，登录".WEBNICK."后去淘宝网购物后还可返还1.5%至30%的现金 @".WEBNICK." ".$webset['tgurl']."?rec=".$dduser['id'])?>" target="_blank"><IMG src="<?=TPLURL?>/images/share_06.gif" width=49 height=49><BR>鲜果网</A> </LI>
  <LI><A  href="https://www.google.com/bookmarks/mark?op=edit&bkmk=http%3A%2F%2F<?=URL?>&output=popup&title=<?=urlencode("推荐一个省钱网站——#".WEBNICK."#，登录".WEBNICK."后去淘宝网购物后还可返还1.5%至30%的现金 @".WEBNICK." ".$webset['tgurl']."?rec=".$dduser['id'])?>"  target=_blank><IMG src="<?=TPLURL?>/images/share_07.gif" width=49 height=49><BR>Google书签</A> </LI>
</UL></DIV>
  </div>
            <?php }?>
