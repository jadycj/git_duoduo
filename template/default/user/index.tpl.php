...
if($dduser['txstatus']=='1'){
	...
	if($dduser['money']==0){
		$txstate_msg = "感谢您使用".WEBNICK."，当您购物累积获得返现超过".$webset['tixian']['limit']."元，就可以申请提现。祝您购物愉快！";
...
if(JIFENBAO==2){
	...
	if($dduser['tbtxstatus']=='1'){
		...
		if($dduser['jifenbao']==0){
			$tbtxstate_msg = "感谢您使用".WEBNICK."，当您购物累积获得返现超过".$webset['tixian']['tblimit'].TBMONEYUNIT.TBMONEY."，就可以申请提现。祝您购物愉快！";
			...
			$.ajax({
				...
				success: function(data){
			    	if(data.s==0){
						...
						alert('签到完成，获得<?=strip_tags($sign_get)?>');
    	...
    	<div class="adminmain">
            ...
            <?php if($default_pwd!=''){?>
             ...
             <?php include(TPLPATH."/user/notice.tpl.php");?>
                ...
                <?php }?>
                <?php if($api_login_tip || $caiwu_tip || $mobile_tip){?>
