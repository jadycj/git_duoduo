...
<?php }?>
    ...
    <?php if($dduser['mobile_test']==1){?>
		<tr>
		  <td width="15%" height="35" style="text-align:right">已验证手机号 *&nbsp;&nbsp;&nbsp;</td>
    ...
    <?php }?>
        <tr class="change">
		  <td width="15%" height="35"  style="text-align:right"><?php if($dduser['mobile_test']==1){?>新<?php }?>手机号码 *&nbsp;&nbsp;&nbsp;</td>
		  ...
		  <div class="img-button"><p><input id="get_mobile_yzm" type="button" value="获取验证码"/></p></div>
		  <?php }?>
          </td>
		</tr>
		<tr class="change">
      ...
      <div class="adminright_yuye" style="width:750px; height:120px">
                    ...
                    <p>以下是<?=WEBNICK?>官方短信号码为，请注意保存，以防被手机软件拦截！<br/>
    ...
    <table border="0" align="left" cellpadding="0" cellspacing="0" bordercolorlight="#9acd32" class="no_table">
    	<?php if($webset['sms']['open']==1){?>
		<tr>
		  <td width="21%" height="35" style="text-align:right">已验证手机号 *&nbsp;&nbsp;&nbsp;</td>
		  <td width="30%"><?=show_mobile($dduser['mobile'])?></td>
		  <td style=" padding-left:20px"><div class="img-button"><p><input id="get_mobile_yzm" type="button" value="获取验证码"/></p></div></td>
		</tr>
        <tr>
		  <td height="35" style="text-align:right">短信验证码 *&nbsp;&nbsp;&nbsp;</td>
		  <td><input name="yzm" id="yzm" style="width:130px;" class="ddinput"/></td>
