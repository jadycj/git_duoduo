      ...
      <?php }?>
        ...
        <div class="ir_cx">
           ...
           <?php foreach($shops as $row){?>
				<dl>
					<dt class="i_border"><a href="<?=$row['jump']?>" target="_blank"><img onerror="this.src='images/tbdp.gif'" src="<?=$row['logo']?>" alt="<?=$row['title']?>" /></a></dt>
					<dd><a href="<?=$row['jump']?>" target="_blank"><?=$row['title']?></a><span>最高返:<b><?=$row['fanxianlv']?></b>%</span></dd>
				</dl>
           <?php }?>
			</div>
		</div>
