...
<!--商家简介开始-->
<div class="mall2xx">
<div class="mall2xxwz"> 当前位置：<a href="<?=u('index')?>">首页</a> > <a href="<?=u('mall','list')?>">商城返现</a> > <?=$mall['title']?></div>
...
<TABLE id=pmenu1 cellSpacing=0 cellPadding=0 width=648>
  ...
  <TR>
    <TD>
      <DIV class=t_p_b>&nbsp;&nbsp;&nbsp;&nbsp;把您在【<?=$mall['title']?>】的购物经历写下来，请具体指出【<?=$mall['title']?>】做的好或不好之处，您真实的体会将给大家带来十分有价值的参考。<?=WEBNICK?>感谢您的积极参与！</DIV></TD></TR>
  <TR>
