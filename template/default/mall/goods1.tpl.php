<div class="goodslist_main" id="splistbox">
                    ...
                    <?php foreach($goods as $row) {?>
                        ...
                        <div class="goodslist_main_left">
                            ...
                            <div class="goodslist_main_left_seller"><p>商家：<a href="<?=$row['mall_jump']?>" target=_blank><?=$row['mall_name']?></a> <?=$row['renzheng']?'<img alt="网站认证" src="'.TPLURL.'/images/renzheng.gif" />':''?></p>
                            </div>
                        </div>
