<div class="goodslist_main_2">
                    ...
                    <?php foreach($goods as $row) {?>
                        <li class="info" style="height:322px;">
                            ...
                            <div class="goodslist_main_left_seller_2"><p>商家：<a href="<?=$row['mall_jump']?>" target=_blank><?=$row['mall_name']?></a> <?=$row['renzheng']?'<img alt="网站认证" src="'.TPLURL.'/images/renzheng.gif" />':''?></p>
                            </div>
