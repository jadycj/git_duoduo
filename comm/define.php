...
define('DOMAIN_PREG',"/[\x80-\xff\w-]+\.(com|net|org|gov|la|cc|biz|info|cn|tk|mobi|co|so|tel|tv|name|asia|me|pk|in|ru|vc|sc|cd|gd|cm|hk|li|中国|公司|网络)((\.cn|\.hk|))$/");
define('DD_OPEN_JFB_HELP_URL','http://auth.duoduo123.com/jfb.php');
define('DD_OPEN_SMS_HELP_URL','http://auth.duoduo123.com/sms.php');
define('DD_OPEN_URL','http://open.duoduo123.com');
define('DD_YUN_URL','http://yun.duoduo123.com');
define('DD_OPEN_JFB_REG_URL',DD_OPEN_URL.'/index.php?m=user&a=reg&url=');
define('CHARSET','UTF-8');
define('TAO_REPORT_GET_NUM',40);
?>