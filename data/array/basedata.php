<?php
 return array (
  ...
  array (
    ...
    'addtime' => 'int(10) NOT NULL',
    'sort' => 'int(11) NOT NULL default "0"',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `tao_id` (`tao_id`),KEY `trade_id` (`trade_id`),KEY `title` (`title`),KEY `cid` (`cid`),KEY `sort` (`sort`)',
  ),
  'baobei_blacklist' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `sdate` (`sdate`)',
  ),
  'income' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `merchant` (`merchant`),KEY `cid` (`cid`),KEY `sort` (`sort`),KEY `edate` (`edate`),KEY `duomaiid` (`duomaiid`),KEY `yiqifaid` (`yiqifaid`),KEY `chanetid` (`chanetid`)',
  ),
  'mall_comment' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `order_time` (`order_time`),KEY `mall_id` (`mall_id`),KEY `adid` (`adid`),KEY `uid` (`uid`),KEY `status` (`status`),UNIQUE KEY `unique_id` (`unique_id`)',
  ),
  'menu' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    'id' => 'int(11) NOT NULL auto_increment',
    'uid' => 'int(11) NOT NULL default "0"',
    'shijian' => 'tinyint(4) NOT NULL default "0"',
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `uid` (`uid`)',
  ),
  'msgset' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),UNIQUE KEY `dealId` (`dealId`),KEY `uid` (`uid`),KEY `addtime` (`addtime`),KEY `checked` (`checked`)',
  ),
  'plugin' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),UNIQUE KEY `code` (`code`),UNIQUE KEY `key` (`key`)',
  ),
  'role' => 
  array (
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),UNIQUE KEY `nick` (`nick`),KEY `cid` (`cid`),UNIQUE KEY `sid` (`sid`),KEY `sort` (`sort`),KEY `index_top` (`index_top`)',
  ),
  'slides' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
  ...
  array (
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `uid` (`uid`),KEY `code` (`code`),KEY `ip` (`ip`)',
  ),
  'tradelist' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
    ...
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),UNIQUE KEY `trade_id` (`trade_id`),KEY `checked` (`checked`),KEY `uid` (`uid`)',
  ),
  'tuan_goods' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
    ...
    'sort' => 'int(10) NOT NULL default "0"',
    'top' => 'tinyint(1) NOT NULL default "0"',
    'salt' => 'bigint(13) NOT NULL default "0"',
    'content' => 'text default NULL',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `city` (`city`),KEY `title` (`title`),KEY `sort` (`sort`),UNIQUE KEY `salt` (`salt`)',
  ),
  'tuan_type' => 
  array (
  ...
  array (
	...
	'platform'=> 'tinyint(1) NOT NULL DEFAULT "1"',
    'duoduo_table_index' => 'PRIMARY KEY  (`id`),KEY `alipay` (`alipay`),UNIQUE KEY `email` (`email`)',
  ),
  'user_temp' => 
  array (
    'id' => 'int(11) NOT NULL auto_increment',
